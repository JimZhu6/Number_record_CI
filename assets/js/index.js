var tools = (function () {
  ...
  var _pageInit = function () {
    ...
    // 检测当前数据库里的数据量
    $.ajax({
      url: "/php/number_record/get_telephone_count.php",
      success: function (res) {
        res = JSON.parse(res);
        if (res.code === 200) {
          let txt =
  ...
  var _numberRecordBindEvent = function () {
    ...
    $("#import-hide-txt").on("change", function (e) {
      ...
      fd.append("file", f);
      $.ajax({
        url: "/php/number_record/updata_txt.php",
        type: "post",
        data: fd,
        processData: false,
        contentType: false,
    ...
    $("#import-hide-excel").on("change", function (e) {
      ...
      fd.append("file", f);
      $.ajax({
        url: "/php/number_record/updata_excel.php",
        type: "post",
        data: fd,
        processData: false,
        contentType: false,
  ...
  var _submitTelEvent = function () {
    ...
    $.post("/php/number_record/input_submit.php", data, function (res) {
      res = JSON.parse(res);
      M.toast({
        html: res.msg
      });
  ...
  var _searchEvent = function () {
    ...
    $.get("/php/number_record/search.php", data, function (res) {
      res = JSON.parse(res);
      let data = res.data;
      if (res.code === 200) {
        let ele = "";
  ...
  var _markEvent = function () {
    ...
    $.post("/php/number_record/submit_remarks.php", data, function (res) {
      res = JSON.parse(res);
      if (res.code === 200) {
